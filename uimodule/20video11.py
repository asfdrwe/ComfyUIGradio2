...
def generate(unethigh, checkboxhigh, lorahigh, strhigh, unetlow, checkboxlow, loralow, strlow, clip, vae, image1, image2, positive, width, height, length, seed, progress = gr.Progress()):
    if seed == '-1':
